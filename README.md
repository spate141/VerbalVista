...
![Static Badge](https://img.shields.io/badge/VerbalVista-3.0-blue) [![Docker Image CI](https://github.com/spate141/VerbalVista/actions/workflows/docker-image.yml/badge.svg)](https://github.com/spate141/VerbalVista/actions/workflows/docker-image.yml) [![Create releases](https://github.com/spate141/VerbalVista/actions/workflows/create-releases.yml/badge.svg)](https://github.com/spate141/VerbalVista/actions/workflows/create-releases.yml)
...
>> docker build -t verbalvista:3.0 .
```

### Start the docker image:
```cmd
>> docker run -p 8501:8501 --env-file /path/to/your/envfile/.env verbalvista:3.0
```
