...
def initialize_summarization_chain(
        model_name: str = "gpt-3.5-turbo", temperature: float = 0.5, max_tokens: int = 512,
        chain_type: str = "map_reduce", verbose: bool = False
):
    """
...
def summarize(chain=None, text=None, chunk_size=4000, question=None, chat_history=None):
    """
    Summarize text.
    """
    docs = process_text(text, chunk_size=chunk_size)
